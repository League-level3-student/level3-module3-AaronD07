...
public class TestCityTaxes {
	...
	public void testPrjections() {
		...
		assertEquals(3870808.0, cities.get(1).getAnnualTaxes(), 0.01); 
		assertEquals(5316400.0, cities.get(2).getAnnualTaxes(), 0.01);
		assertEquals(945044.3, cities.get(3).getAnnualTaxes(), 0.01);
